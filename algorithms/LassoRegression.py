...
def cross_val(historic_train, historic_target, future_test, future_real_target):
    ...
    # Cross validation for lasso regression alpha parameter
    model = Lasso()
    ...
    results = pd.DataFrame.from_dict(gsearch.cv_results_)
    return results
...
print(result,  file=open('../algorithms/results/LassoRegression.txt', 'w'))
